...
| 6 | **7-day trial expires ~April 2** — existential risk | Critical | High | SURVIVAL MODE: revenue pipeline active | 🔴 Active — **5 days PAST** (running, landing pages live, but API services NOT deployed) |
